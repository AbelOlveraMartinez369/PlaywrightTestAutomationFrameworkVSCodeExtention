...
test.describe('Regression Testing Suite', () => {
    ...
    test.beforeEach(async () => {
        ...
        await accoreeAdminLogin.clearBrowserCache();
    ...
    test('[JIRA] (SWF-547) Admin Login: To verify that the login button is disabled when no data is entered', async () => {
        try {
            console.log('Inside Try of Admin Login: To verify that the login button is disabled when no data is entered');
            ...
            console.log('Inside Catch of Admin Login: To verify that the login button is disabled when no data is entered');
